...
{
    //    var self = this;
    //    var idActiveTab, idsAccordion, accordionContents;
    //-----------------------
    ...
    // Установим события открытия закладок параметров
    //        this.iniClickTab();
    ...
    $.ajax({
        ...
        success: function(jsonData) {
            ...
            if(BSA.Sys.checkAjaxData(jsonData)){
                ...
                $.each(this.$tags, function(i, chartTag) { 
                    ...
                    if(tags){
                        ...
                        var tagOptions = {};
                        tagOptions.value_title = jsonDataConfig['comment'];
                ...
                if(!this.$lastUpdateTime){
                    this.$lastUpdateTime = jsonData.time;
//                    var getUpdateData = this.getUpdateData.bind( this );
//                    var getUpdateData = $.proxy(this.getUpdateData,this);
                    this.$intervalID = setInterval($.proxy(this.getUpdateData,this), this.$update_period);
                }
